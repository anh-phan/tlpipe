...
class Dispatch1(timestream_task.TimestreamTask):
    """Dispatch data.
    ...
    def __init__(self, parameter_file_or_dict=None, feedback=2):
        ...
        super(Dispatch1, self).__init__(parameter_file_or_dict, feedback)
    ...
    def read_process_write(self, tod):
        ...
        return super(Dispatch1, self).read_process_write(tod)
    ...
    def data_select(self, tod):
        """Data select."""
        tod, full_data = super(Dispatch1, self).data_select(tod)
    ...
    def process(self, rt):
        ...
        return super(Dispatch1, self).process(rt)
